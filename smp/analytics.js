(function() {
    ...
    var oc = function() {
      ...
      , ge = function(a, b, c) {
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j55", "sr=1"],
        b && a.push("_f=" + b),
      ...
      , na = function(a, b) {
        if (!b || 1 > b.length)
            ...
            for (var c = [], d = 0; d < b.length; d++) {
                ...
                var g = e.split(".");
                var ca = g.shift();
                ("GA1" == ca || "1" == ca) && 1 < g.length ? (e = g.shift().split("-"),
                1 == e.length && (e[1] = "1"),
                e[0] *= 1,
                e[1] *= 1,
                g = {
        ...
        c = E(M.location[c ? "href" : "search"], "_ga"))
            if (a.get(bc))
                ...
                -1 == d)
                    ...
                    if ("1" == e) {
                        if (d = g,
                        c != Ic(d, 0) && c != Ic(d, -1) && c != Ic(d, -2) && c != pa(d, 0) && c != pa(d, -1) && c != pa(d, -2)) {
                            J(23);
                            break a
                        }
                    } else if ("2" == e) {
    ...
    Z.J = function(a) {
        for (var b, c = [], d = 0; d < arguments.length; d++)
            try {
                ...
                b.g ? C(b.a[0], b.a[1]) : (b.i && (b.ha = y(b.c, b.a[0], b.X, b.W)),
                c.push(b))
            } catch (e) {}
        return c
    }
