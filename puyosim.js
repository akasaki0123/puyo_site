...
var newField = !1, canvas, ctx, img, hartBoxProb = 100, 
    puyoNum = 5, ndouwa = 4, flag_tenkishi = 0 /*new var by akasaki*/
, shuffleNum = 0, field = [[], [], [], [], [], []], nextField = [], copyField = [[], [], [], [], [], []], copyNextField = [], selectNow = !1, selectComplete = !1, mouseCursor = new Point(0,0), selectPuyoPoint = [], selectPuyoNum = 0, selectPuyoMax = 5 /*ぷよ数変えるときはここ*/, selected = !1, rensaPuyoList, rensaPuyoListNum, maxDamage, maxRensaNum, maxRensaToDeletePuyo, maxDeletePuyoNum, maxDeletePuyoToRensa, maxDamagePointNum, maxRensaPointNum, maxDeletePuyoPointNum, simulated = !1, showMaxDeletePuyo, showMaxDamage, showMaxRensa;
$(function() {
    NotPcJump();
    var a = GetParam();
...
function EventSetting() {
    $("#puyo").mousedown(function(a) {
        1 != a.which || selected || (selectNow = !0,
        mouseCursor.x = a.offsetX,
        mouseCursor.y = a.offsetY)
    });
    $("#puyo").mouseup(function(a) {
        1 == a.which && selectNow && !selected && (0 == selectPuyoNum ? selectNow = !1 : selectComplete = !0)
    });
    $("#puyo").mouseout(function(a) {
        selectNow = !1;
        SelectClear()
    });
    $("#puyo").mousemove(function(a) {
        selectNow && (mouseCursor.x = a.offsetX,
        mouseCursor.y = a.offsetY)
    });
   ...
   /* $("#ryoshi").click(function() {
    ...
    var a = ["modeNomal", "modeChance", "modeQuestion"];
    $("#modeSelect").change(function() {
        DataInit();
        SimDataInit();
        shuffleNum = 0;
        $("#" + a[mode]).css("display", "none");
        mode = parseInt($(this).val());
        $("#" + a[mode]).css("display", "inline");
        0 == mode && FieldInit();
